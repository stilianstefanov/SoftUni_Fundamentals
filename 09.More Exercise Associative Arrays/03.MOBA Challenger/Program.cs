...
namespace _03.MOBA_Challenger
{
        ...
        static void Main(string[] args)
        {
            ...
            while (input != "Season end")
            {
                ...
                else
                {
                    ...
                    if (playersList.Any(player => player.Name == currFirstPlayerName) 
                        && playersList.Any(player2 => player2.Name == currSecondPlayerName))
                    {
    ...
    class Player
    {
        ...
        public int TotalPoints { get { return this.PositionPoints.Values.Sum(); } }
    }
}
