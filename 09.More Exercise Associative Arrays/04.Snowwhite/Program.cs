...
namespace _04.Snowwhite
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (var dwarf in dwarfList.OrderByDescending(dwarf => dwarf.Physics)
                .ThenByDescending(dwarf => dwarfList.Where(listdwarf => listdwarf.HatColor == dwarf.HatColor).Count())                )
            {
